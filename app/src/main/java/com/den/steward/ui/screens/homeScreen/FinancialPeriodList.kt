    ...
    Row(
        ...
        Column(
            ...
            Row(
                ...
                transaction.getPaymentMethodOrNull?.let { method ->
                    Image(
                ...
                Image(
                    ...
                    contentDescription = stringResource(transaction.type.label),
                    modifier = Modifier.size(16.dp),
                    colorFilter = ColorFilter.tint(colorResource(transaction.type.color))
                )
            }
        }
    }
